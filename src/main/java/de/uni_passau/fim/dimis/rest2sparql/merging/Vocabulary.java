...
public class Vocabulary {
    ...
    public static final Resource QB_DIMENSION_PROPERTY = model.createResource(QB_URI + "DimensionProperty");
    ...
    public static final Property DC_RELATION = model.createProperty(DC_URI + "relation");

    // CODE vocabulary (need UUID as suffix)
    public static final Resource CODE_ENTITY_DEF = model.createResource(CODE_URI + "Entity");
    ...
    public static final String CODE_DEF = CODE_URI + "Def-";
